...
print('Document id: %d' % sample)
print('Probability(christian) =', c.predict_proba([newsgroups_test.data[sample]])[0,1])
print('True class: %s' % class_names[newsgroups_test.target[sample]])
exp.as_list()
